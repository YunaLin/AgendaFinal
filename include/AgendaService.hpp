...
class AgendaService {
   public:
     ...
     */
    void updateEmail(std::string userName, std::string password, std::string newEmail);
    void updatePassword(std::string userName, std::string password, std::string newEmail);
    void updatePhone(std::string userName, std::string password, std::string newEmail);
    void updateMeetingByTitle(std::string sponsor, std::string title, std::string startDate,
        std::string endDate, std::vector<std::string> participator);
